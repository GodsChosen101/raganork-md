...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~6b3b60df48cbfcc4c029e66d470b92a8:314b4664617274526165513d').trim() || '',
    ...
    BOT_NAME: process.env.BOT_NAME || 'GodsChosen_bot',
    ...
    SUDO: process.env.SUDO || "2347017790779",
